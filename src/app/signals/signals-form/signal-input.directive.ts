...
// Integrating form fields with ngModel and FormField Objects, providing two-way data binding 
@Directive({
...
export class SignalInputDirective implements OnInit {
  ...
  /**
   * Called when the ngModel value changes
   * @param value 
   */
  ...
  constructor() {
    /**
     * Ensure that the ngModel control reflects the form field value
     * 
     */
    effect(() => {
